...
import com.data2act.tinyradius.attribute.IntegerAttribute;
...
public class AccountingRequest extends RadiusPacket {
	 ...
	 * 
	 * @see com.data2act.tinyradius.packet.RadiusPacket#updateRequestAuthenticator(java.lang.String, int, byte[])
	 */
