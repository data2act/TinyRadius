 ...
 */
package com.data2act.tinyradius.attribute;
...
public class VendorSpecificAttribute extends RadiusAttribute {
	 ...
	 * @param dictionary
	 *            dictionary to set
	 * @see com.data2act.tinyradius.attribute.RadiusAttribute#setDictionary(com.data2act.tinyradius.dictionary.Dictionary)
	 */
	 ...
	 * 
	 * @see com.data2act.tinyradius.attribute.RadiusAttribute#writeAttribute()
	 */
	 ...
	 * structure.
	 * 
	 * @see com.data2act.tinyradius.attribute.RadiusAttribute#readAttribute(byte[], int, int)
	 */
	 ...
	 * 
	 * @see com.data2act.tinyradius.attribute.RadiusAttribute#toString()
	 */
